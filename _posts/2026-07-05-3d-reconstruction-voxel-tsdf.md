...
> [학습 로드맵]({% post_url 2026-07-05-3d-reconstruction-roadmap %})의 세 번째 표현. 여러 프레임의 [point cloud]({% post_url 2026-07-05-3d-reconstruction-point-cloud %})을 하나의 **격자(volume)**로 융합해 매끈한 표면을 만드는 방법이다.
